...
<form action = "Hw1.Q1.php" method = "get">
...
echo "When you swam for ", $SwimTime , " minutes, you burned ", $Swimming * $SwimTime, " calories.<br>";
echo "When you biked for ", $BikeTime , " minutes, you burned ", $Bicycling * $BikeTime, " calories.<br>";
echo "When you jogged for ", $JogTime , " minutes, you burned ", $Jogging * $JogTime, " calories.<br>";
echo "The total calories burned is: ", $TotalCalories, "<br>";
$PoundsLost = $TotalCalories / 3500;
echo "The total pounds lost is: ", $PoundsLost;
