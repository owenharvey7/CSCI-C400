...
<form action = "Q1PoundsCalculator.php" method = "get">
    ...
    <td><input type="submit" name="submitButton" id="submitButton" value="Compute Pounds Lost" /></td>
    <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
...
echo "<h2>", CALORIES, "</h2>";
echo " Calculating the total calories burned based on input", "</p>";
